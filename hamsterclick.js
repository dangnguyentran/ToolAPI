...
const csvData = fs.readFileSync('authorizationhamster.csv', 'utf8');
...
async function main() {
    while (true) {
        ...
        console.log('Đã chạy xong tất cả các token, nghỉ 18 phút rồi chạy lại từ đầu...');
        await new Promise(resolve => setTimeout(resolve, 1080000));
    }
}
